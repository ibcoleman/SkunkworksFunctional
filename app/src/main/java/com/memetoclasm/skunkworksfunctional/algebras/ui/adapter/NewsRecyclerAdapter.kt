package com.memetoclasm.skunkworksfunctional.algebras.ui.adapter
...
import com.memetoclasm.skunkworksfunctional.algebras.ui.adapter.NewsRecyclerAdapter.ViewHolder
import com.memetoclasm.skunkworksfunctional.algebras.ui.model.NewsItemViewState
import com.squareup.picasso.Picasso
import kotlinx.android.synthetic.main.item_news.view.*

class NewsRecyclerAdapter( var news: List<NewsItemViewState> = ArrayList(), val itemClick: (NewsItemViewState) -> Unit) : RecyclerView.Adapter<ViewHolder>() {
